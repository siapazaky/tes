...
let name = await conn.getName(who)
 ...
 conn.send3ButtonImg(m.chat, result.data, `Effect *${effect}nya* Dah Jadi ${tag}`,wm, 'Menu', '.menu', 'Owner', '.owner', 'Credit', '.tqto', global.fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: linkig,
    mediaType: 1, 
